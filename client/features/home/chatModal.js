...
const ChatModal = ({ handleCloseModal, handleAcceptGuideline }) => {
  return (
    ...
    >
      <div className="h-[60vh] w-[50vw] py-5 px-10 rounded-md bg-white z-10 flex items-center ">
        <div>
          <h3 className="text-5xl">Guidlines</h3>
          <p>
            ...
            respectful experience. Rules: 1. Be respectful of others. Do not use
            hate speech, make personal attacks, or engage in any other behavior
            that could be considered harassment or bullying. 2. Keep the
            conversation on topic. Please avoid discussing topics that are
            unrelated to the channel or server you are in. 3. No spamming or
            self-promotion. Do not post the same message repeatedly or use the
            server to promote your own content or services without permission.
            4. Do not share inappropriate content. This includes anything that
            is violent, sexually explicit, or discriminatory in nature. 5.
